...
class DailyLogbookUI:
    ...
    def __init__(self, root, storage):
        ...
        self.image_exporter = ImageExporter(self.settings_manager)
        self.dialog_manager = DialogManager(self.root, self.settings_manager, self.image_exporter, self.storage)
    ...
    def show_options(self):
        ...
        self.dialog_manager.show_export_settings(self.selected_date)
    ...
    def copy_as_image(self):
        ...
        try:
            ...
            formatted_date = self.selected_date       
        try:
            img = self.image_exporter.create_table_image(formatted_date, activities)
            self.image_exporter.copy_image_to_clipboard(img)
